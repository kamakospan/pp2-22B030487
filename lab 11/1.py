...
DECLARE
   m   text[];
   num int;
   arr text[] := '{{erlanov,arsen,12345},{erzhanov,erzhan, 46465},{timurov, timur, 46451}}'; 
BEGIN
...
""")
cur.execute("""SELECT *
FROM search_from_pb_byname('heeloolol');""")
print(cur.fetchall())
cur.execute("""CALL insert_to_pb('Kama', 'Kospan', 66);""")
cur.execute("""SELECT *
FROM paginating(5, 2);""")
print(cur.fetchall())
